"""End-to-end verification flow tests — ARELLO mocked, Celery eager."""
import pytest
import responses
...
@override_settings(
    ARELLO_BASE_URL="https://lvws.example.com",
...
class TestRunVerification:
    ...
    def test_active_grants_verified(self, profile):
        responses.add(
            responses.GET, "https://lvws.example.com/api/v2/search",
    ...
    def test_arello_down_logs_no_grant(self, profile):
        ...
        assert profile.verification_status == VerificationStatus.PENDING  # unchanged
